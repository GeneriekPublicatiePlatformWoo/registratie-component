...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "odrc"),
        "USER": config("DB_USER", "odrc"),
        "PASSWORD": config("DB_PASSWORD", "odrc"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "odrc.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "odrc.wsgi.application"
...
DEFAULT_FROM_EMAIL = "odrc@example.com"
...
AUTHENTICATION_BACKENDS = [
    ...
    "odrc.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "odrc_sessionid"
...
CSRF_FAILURE_VIEW = "odrc.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "odrc.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "odrc"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"odrc {ENVIRONMENT}",
