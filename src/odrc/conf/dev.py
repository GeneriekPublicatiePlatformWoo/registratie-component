...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-y+ft+x%cn27$#aburc25w22+r6g*zucacw19)oa^@sqg+(5ew%",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "odrc")
os.environ.setdefault("DB_USER", "odrc")
os.environ.setdefault("DB_PASSWORD", "odrc")
