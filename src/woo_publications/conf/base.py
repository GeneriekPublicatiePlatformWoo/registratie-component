...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "woo_publications"),
        "USER": config("DB_USER", "woo_publications"),
        "PASSWORD": config("DB_PASSWORD", "woo_publications"),
...
ROOT_URLCONF = "woo_publications.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "woo_publications.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "woo_publications.wsgi.application"
...
DEFAULT_FROM_EMAIL = "woo_publications@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "woo_publications.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "woo_publications.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "woo_publications_sessionid"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"woo_publications {ENVIRONMENT}",
